...
namespace SportsStore.Tests
{
    public class ProductControllerTests
    {
        ...
        public void Can_Filter_Products()
        {
            ...
            // Action
            var result =
                (controller.Index("Cat2").ViewData.Model as ProductsListViewModel)!
                .Products.ToArray();
            // Assert
        ...
        public void Generate_Category_Specific_Product_Count()
        {
            ...
            // Action
            var res1 =
                GetModel(target.Index("Cat1"))?.PagingInfo.TotalItems;
            var res2 =
                GetModel(target.Index("Cat2"))?.PagingInfo.TotalItems;
            var res3 =
                GetModel(target.Index("Cat3"))?.PagingInfo.TotalItems;
            var resAll
                = GetModel(target.Index(null))?.PagingInfo.TotalItems;
